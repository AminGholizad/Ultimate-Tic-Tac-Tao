...
public:
  ...
  using Board3x3 =
      std::array<std::array<Player, THREE>, THREE>; // TODO: convert to linear
  ...
  [[nodiscard]] constexpr auto game_over() const & {
    return std::make_tuple(winner.isDraw(), winner == player,
...
private:
  ...
  [[nodiscard]] Player compute_winner(const Player &test_palyer) const &;
